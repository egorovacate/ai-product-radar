...
const index = layout("AI Product Radar — авторская аналитика об AI-продуктах", indexDescription, "/radar/index.html", `<header class="top"><div><div class="brand">Авторская аналитика · Technology scouting</div><h1 class="title">AI Product Radar</h1><p class="subtitle">Подробные доказательные разборы AI-продуктов, coding agents, business analysis и внутренних платформ. Каждый выпуск доступен на русском и британском английском.</p></div><aside class="factbox"><strong>${russianDigests.length}</strong><span>${russianDigests.length === 1 ? "двуязычный выпуск" : "двуязычных выпусков"}</span></aside></header><section class="method"><h2>Редакционный принцип</h2><p>Radar опирается преимущественно на первичные источники, документацию и исследования. Заявления поставщиков обозначаются как заявления, ограничения не скрываются, а факты отделяются от авторских выводов. Английская версия сохраняет полный объём и использует британский английский.</p></section><div class="archive-head"><h2>Выпуски</h2><span class="meta">Новые тематические обзоры по мере накопления значимых изменений</span></div><section class="grid">${cards}</section>`);
